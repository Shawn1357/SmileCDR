...
JAVA=java
LOGBACK_FILE=DLQWatcher-logback.xml
JAR_FILE=dlqutilities.jar
MAIN_CLASS_NAME=ca.ontariohealth.smilecdr.dlqwatcher.DLQWatcher
CFG_FILE=./DLQWatcher.properties
CMD_LINE_OPTS=--initCmd LIST --initCmd START
...
$JAVA $JVM_OPTS -classpath $CLSPATH $MAIN_CLASS_NAME --envName --cfgFile $CFG_FILE $ENV_NAME $CMD_LINE_OPTS
